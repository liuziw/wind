...
import com.lzw.wind.tibmas.core.daomanager.immutable.ImmutableUserDaoManager;
import com.lzw.wind.tibmas.core.dbo.UserDO;
import com.lzw.wind.tibmas.core.mapper.UserMapper;
...
public class ImmutableUserDaoManagerImpl extends CommonDaoManagerImpl<UserDO,Long> implements ImmutableUserDaoManager {
        ...
        public List<UserDO> listByUpdatePasswordTime(Date updatePasswordTime, String... fieldNames){
            return this.userMapper.listByUpdatePasswordTime(updatePasswordTime,super.javaFieldNames2DataBaseNames(fieldNames));
        }

        public Map<Long,UserDO> mapByUpdatePasswordTime(Date updatePasswordTime, String... fieldNames){
            return this.userMapper.mapByUpdatePasswordTime(updatePasswordTime,super.javaFieldNames2DataBaseNames(fieldNames));
        }

        public Integer countByUpdatePasswordTime(Date updatePasswordTime){
            return this.userMapper.countByUpdatePasswordTime(updatePasswordTime);
        }

        public Integer updateNotNullFieldsByUpdatePasswordTime(UserDO updateDO, Date updatePasswordTime){
            if (super.doChecker != null){
                super.doChecker.checkWhenModify(updateDO);
            }
        ...
        public Integer updateAllFieldsByUpdatePasswordTime(UserDO updateDO,  Date updatePasswordTime){
            if (super.doChecker != null){
                super.doChecker.checkWhenModify(updateDO);
            }
        ...
        public Integer deleteByUpdatePasswordTime( Date updatePasswordTime){
            return this.userMapper.deleteByUpdatePasswordTime(updatePasswordTime);
        }



        public List<UserDO> listByInUpdatePasswordTime(Collection<Date> updatePasswordTimeList, String... fieldNames){
        ...
        public Map<Long,UserDO> mapByInUpdatePasswordTime(Collection<Date> updatePasswordTimeList, String... fieldNames){
            if(CollectionUtils.isEmpty(updatePasswordTimeList)){
                 return new HashMap<>();
            }
        ...
        public Integer countByInUpdatePasswordTime(Collection<Date> updatePasswordTimeList){
            if(CollectionUtils.isEmpty(updatePasswordTimeList)){
                   return 0;
             }
        ...
        public Integer updateNotNullFieldsByInUpdatePasswordTime(UserDO updateDO, Collection<Date> updatePasswordTimeList){
            if(CollectionUtils.isEmpty(updatePasswordTimeList)){
                  return 0;
             }
            if(super.doChecker != null){
        ...
        public Integer updateAllFieldsByInUpdatePasswordTime(UserDO updateDO,  Collection<Date> updatePasswordTimeList){
            if(CollectionUtils.isEmpty(updatePasswordTimeList)){
                           return 0;
             }
            if(super.doChecker != null){
        ...
        public Integer deleteByInUpdatePasswordTime( Collection<Date> updatePasswordTimeList){
            if(CollectionUtils.isEmpty(updatePasswordTimeList)){
                           return 0;
             }
        ...
        public List<UserDO> listByBirthday(Date birthday, String... fieldNames){
            return this.userMapper.listByBirthday(birthday,super.javaFieldNames2DataBaseNames(fieldNames));
        }

        public Map<Long,UserDO> mapByBirthday(Date birthday, String... fieldNames){
        ...
        public Integer updateNotNullFieldsByBirthday(UserDO updateDO, Date birthday){
            if (super.doChecker != null){
                super.doChecker.checkWhenModify(updateDO);
            }
        ...
        public Integer updateAllFieldsByBirthday(UserDO updateDO,  Date birthday){
            if (super.doChecker != null){
                super.doChecker.checkWhenModify(updateDO);
            }
        ...
        public List<UserDO> listByInBirthday(Collection<Date> birthdayList, String... fieldNames){
        ...
        public Map<Long,UserDO> mapByInBirthday(Collection<Date> birthdayList, String... fieldNames){
            if(CollectionUtils.isEmpty(birthdayList)){
                 return new HashMap<>();
            }
        ...
        public Integer updateNotNullFieldsByInBirthday(UserDO updateDO, Collection<Date> birthdayList){
            if(CollectionUtils.isEmpty(birthdayList)){
                  return 0;
             }
            if(super.doChecker != null){
        ...
        public Integer updateAllFieldsByInBirthday(UserDO updateDO,  Collection<Date> birthdayList){
            if(CollectionUtils.isEmpty(birthdayList)){
                           return 0;
             }
            if(super.doChecker != null){
        ...
        public List<UserDO> listByLockedTime(Date lockedTime, String... fieldNames){
            return this.userMapper.listByLockedTime(lockedTime,super.javaFieldNames2DataBaseNames(fieldNames));
        }

        public Map<Long,UserDO> mapByLockedTime(Date lockedTime, String... fieldNames){
            return this.userMapper.mapByLockedTime(lockedTime,super.javaFieldNames2DataBaseNames(fieldNames));
        }

        public Integer countByLockedTime(Date lockedTime){
            return this.userMapper.countByLockedTime(lockedTime);
        }

        public Integer updateNotNullFieldsByLockedTime(UserDO updateDO, Date lockedTime){
            if (super.doChecker != null){
                super.doChecker.checkWhenModify(updateDO);
            }
        ...
        public Integer updateAllFieldsByLockedTime(UserDO updateDO,  Date lockedTime){
            if (super.doChecker != null){
                super.doChecker.checkWhenModify(updateDO);
            }
        ...
        public Integer deleteByLockedTime( Date lockedTime){
            return this.userMapper.deleteByLockedTime(lockedTime);
        }



        public List<UserDO> listByInLockedTime(Collection<Date> lockedTimeList, String... fieldNames){
        ...
        public Map<Long,UserDO> mapByInLockedTime(Collection<Date> lockedTimeList, String... fieldNames){
            if(CollectionUtils.isEmpty(lockedTimeList)){
                 return new HashMap<>();
            }
        ...
        public Integer countByInLockedTime(Collection<Date> lockedTimeList){
            if(CollectionUtils.isEmpty(lockedTimeList)){
                   return 0;
             }
        ...
        public Integer updateNotNullFieldsByInLockedTime(UserDO updateDO, Collection<Date> lockedTimeList){
            if(CollectionUtils.isEmpty(lockedTimeList)){
                  return 0;
             }
            if(super.doChecker != null){
        ...
        public Integer updateAllFieldsByInLockedTime(UserDO updateDO,  Collection<Date> lockedTimeList){
            if(CollectionUtils.isEmpty(lockedTimeList)){
                           return 0;
             }
            if(super.doChecker != null){
        ...
        public Integer deleteByInLockedTime( Collection<Date> lockedTimeList){
            if(CollectionUtils.isEmpty(lockedTimeList)){
                           return 0;
             }
