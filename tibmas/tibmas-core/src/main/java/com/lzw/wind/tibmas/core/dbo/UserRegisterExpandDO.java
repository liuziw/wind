 ...
 */
@Data
public class UserRegisterExpandDO implements java.io.Serializable  {
    ...
    //表名
    public static final String TABLE_NAME="user_register_expand";
     ...
     *register_id
     */
    public static final String  DB_REGISTER_ID="register_id";
